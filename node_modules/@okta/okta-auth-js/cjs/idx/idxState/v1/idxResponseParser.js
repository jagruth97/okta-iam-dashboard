...
const parseNonRemediations = exports.parseNonRemediations = function parseNonRemediations(authClient, idxResponse, toPersist = {}) {
  const actions = {};
  const context = {};
...
const parseIdxResponse = exports.parseIdxResponse = function parseIdxResponse(authClient, idxResponse, toPersist = {}) {
